...
const PriceDetails = () => {
  const {products, totalPrice, totaldiscountedPrice} = useSelector(
    (store: any) => store.mainapi,
  );
  const discount = String(totalPrice - totaldiscountedPrice);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.commonView}>
        ...
        <Text style={[styles.commonText, {color: 'green'}]}>
      ...
      <View style={styles.commonView}>
        ...
        <Text style={styles.totalAmount}>
          ${parseFloat(totaldiscountedPrice).toFixed(2)}
        </Text>
      </View>
    </View>
  );
